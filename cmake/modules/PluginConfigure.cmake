...
function(plugin_configure_target target company backend sources vst3sdk)
	...
	elseif(backend STREQUAL "AUV2")
		...
		smtg_add_vst3plugin(${_local_target} ${sources})
	...
	elseif(backend STREQUAL "VST2")
		set(_local_target ${target})
		smtg_add_vst3plugin(${_local_target} ${sources})
		target_sources(${_local_target} PRIVATE ${vst3sdk}/public.sdk/source/vst/vst2wrapper/vst2wrapper.sdk.cpp)
	else()
		set(_local_target ${target})
		smtg_add_vst3plugin(${_local_target} ${sources})
	endif()
	smtg_target_configure_version_file(${_local_target})
	set_target_properties(${_local_target} PROPERTIES CXX_STANDARD 17)
endfunction()
