...
static const AAX_CEffectID kEffectID_DemoDelay = "com.avid.aax.sdk.demodelay";
...
static AAX_Result DescribeEffect( AAX_IEffectDescriptor * outDescriptor )
{
	...
	// Effect identifiers
	//
	err = outDescriptor->AddName ( "Demo Delay" );
...
AAX_Result GetEffectDescriptions( AAX_ICollection * outCollection )
{
	...
	err = outCollection->AddPackageName( "DemoDelay AAX SDK Example Plug-In" );
